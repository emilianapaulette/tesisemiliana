<?php 
  ...
  if (!empty($_POST)) {
        ...
        $query = "INSERT INTO usuario (`idusuario`, `fullname`, `username`, `password`, `rol`) VALUES (NULL, '$fullname', '$username', '$password', '$rol');";
    ...
    <div class="downp">
    	...
    	<div class="frm_registrar">
			<form method="post" action="registrarusuario.php">
    			...
    			<label>Rol</label>
                <br>
    			<input name="rol" placeholder="rol" type="text" class="iwi" required>
