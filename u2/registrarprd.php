    ...
    <div class="downp">
    	...
    	<div class="frm_registrar">
			<form method="post" action="registrarprd.php">
                ...
                <br>
    			<input name="descripcion" type="text" class="iwi" placeholder="Descripcion de producto" required pattern="[a-zA-Z]+>
                <br><br>
				

    			<label>Precio</label>
                <br>
    			<input name="precio"type="text" class="iwi" placeholder="Precio de producto" required pattern="[0-9]+">
				<br><br>
				
				<label>Existencia</label>
                <br>
    			<input name="existencia" type="text" class="iwi" placeholder="Existencia de producto" required pattern="[0-9]+">
                <br><br>
