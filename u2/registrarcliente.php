    ...
    <div class="downp">
    	...
    	<div class="frm_registrar">
			<form method="post" action="registrarcliente.php">
				...
				<label>Nombre</label>
                <br>
    			<input name="nombre" type="text" class="iwi" placeholder="Nombre de cliente" required pattern="[a-zA-Z]+">
                <br><br>
				

    			<label>DNI</label>
                <br>
    			<input maxlength="10" minlength="10" name="RNC" type="text" class="iwi" placeholder="DNI de cliente" required pattern="[0-9]+">
				<br><br>   
                ...
                <br>
                <input maxlength="10" minlength="10" name="telefono" type="option" class="iwi" placeholder="Telefono de cliente" required pattern="[0-9]+">
                <br><br>
