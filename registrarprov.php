    ...
    <div class="downp">
    	...
    	<div class="frm_registrar">
			<form method="post" action="registrarprov.php">
                ...
                <br>
    			<input maxlength="10" minlength="10" name="telefono" type="text" class="iwi" placeholder="Telefono de cliente" required pattern="[0-9]+">
                <br><br>
    			<label>Pais</label>
                <br>
    			<input name="pais" placeholder="pais de proveedor" type="text" class="iwi" required pattern="[a-zA-Z]+">
