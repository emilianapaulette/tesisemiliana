...
<body>
    ...
    <div class="main_content">
    	<h1 class="down">Punto de Venta</h1>
    	<!--div form-->
        ...
        <div class="frms_venta frm_cliente">
          <form name="clienteventa" class="datos" id="clienteventa">
            ...
            <div>
                  <label>DNI</label>
                  <input class="inpidcli" id="RNC" type="text" name="RNC" maxlength="10">
              </div>
              <div class="rnc">
      ...
      <thead>
          <tr>
           ...
           <tr>      
            <td>
            <!--<select id="idproductop" name="idproducto">
                <option value="22">Lavadora</option>
                <option value=23">Aire Acondicionado</option>
              </select>-->
            <input id="idproductop" type="text" name="idproducto">
            </td>
          ...
          <tr>
            ...
            <td class="h1d"><h1>Detalles de punto de venta</h1></td>
